...
"SELECT projects.title, pledges.amount - projects.funding_goal FROM projects JOIN pledges ON projects.id = pledges.project_id GROUP BY pledges.amount HAVING pledges.amount > projects.funding_goal;"
end
