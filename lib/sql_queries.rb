...
"SELECT projects.title, pledges.amount - projects.funding_goal FROM projects JOIN pledges on projects.id = pledges.project_id HAVING pledges.amount > projects.funding_goal"
end
