...
"SELECT projects.category, pledges.amount FROM projects JOIN pledges WHERE projects.id = pledges.project_id GROUP BY pledges.amount HAVING projects.category='music';"
end
