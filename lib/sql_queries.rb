...
"SELECT projects.category, pledges.amount FROM projects JOIN pledges WHERE projects.id = pledges.project_id GROUP BY projects.id HAVING projects.category='music';"
end
